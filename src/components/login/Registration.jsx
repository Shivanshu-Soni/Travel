...
const Registration = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // newData.push({ username: regData.username, password: regData.password })
    // console.log('......', newData)
    // setLoginData(newData)
    if (filterData.includes(regData.username)) {
      //&& (fname==""&&lname==""&&)
      alert(" username already exsits or all field mandatory ");
    } else {
      axios
      ...
      <div className="wrapper text-center container">
        <div className="mb-4">
          <a className="navbar-brand" id="logo">
            <span>R</span>Registration <span>F</span>orm{" "}
          </a>
        </div>
        <form
